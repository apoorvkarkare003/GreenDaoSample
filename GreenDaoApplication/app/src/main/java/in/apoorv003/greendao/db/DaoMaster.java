...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        DirectorDao.createTable(db, ifNotExists);
        ActorDao.createTable(db, ifNotExists);
        ProductionHouseDao.createTable(db, ifNotExists);
    }
    
    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        MovieDao.dropTable(db, ifExists);
        DirectorDao.dropTable(db, ifExists);
        ActorDao.dropTable(db, ifExists);
        ProductionHouseDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(DirectorDao.class);
        registerDaoClass(ActorDao.class);
        registerDaoClass(ProductionHouseDao.class);
    }
